        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (result.get(0).equalsIgnoreCase("movie"))  {
                        switchToMovies();
                    }
                    else if (result.get(0).equalsIgnoreCase("aadhar"))  {
                        aadharReader();
                    }
                    else if (result.get(0).equalsIgnoreCase("silent")||result.get(0).equalsIgnoreCase("silence"))  {
                    ...
                    else if (result.get(0).equalsIgnoreCase("bolo"))  {
